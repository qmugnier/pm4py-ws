...
from pm4pyws.handlers.parquet.process_schema.alpha_freq import get_vis as alpha_freq_vis
from pm4pyws.handlers.parquet.process_schema.alpha_performance import get_vis as alpha_perf_vis
...
VERSIONS = {DFG_FREQ: dfg_freq_vis.apply, DFG_PERF: dfg_perf_vis.apply, TREE_FREQ: tree_vis.apply,
            ...
            INDUCTIVE_PERF: inductive_perf_vis.apply, ALPHA_FREQ: alpha_freq_vis.apply, ALPHA_PERF: alpha_perf_vis.apply}
